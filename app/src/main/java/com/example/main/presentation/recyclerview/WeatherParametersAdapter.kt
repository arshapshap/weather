...
class WeatherParametersAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): WeatherParametersHolder = WeatherParametersHolder(
        ItemWeatherParameterBinding.inflate(
            LayoutInflater.from(parent.context), parent, false
        )
    )

    override fun onBindViewHolder(weatherParametersHolder: WeatherParametersHolder, position: Int) {
